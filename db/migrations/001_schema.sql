-- G6 WhatsApp Audit — PostgreSQL schema (no Supabase / no RLS)
-- Run once on your VPS: psql "$DATABASE_URL" -f db/migrations/001_schema.sql

CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- ============================================================
-- USERS (agency login; no public signup)
-- ============================================================
CREATE TABLE users (
...
CREATE TABLE clients (
  ...
  avg_ticket_value       NUMERIC(10,2) NOT NULL DEFAULT 0,
  created_at             TIMESTAMPTZ NOT NULL DEFAULT NOW(),
